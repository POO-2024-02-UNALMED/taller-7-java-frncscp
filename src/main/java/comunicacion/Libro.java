...
public class Libro extends Escrito{
    ...
    public Libro(tring origen, String titulo, String autor, int paginas, String co_autor, String editorial, String edicion, String interpretacion){
        super(origen, autor, paginas);
    ...
    @Override
    public int palabrasTotales(){return 2 * super.getPaginas();}
